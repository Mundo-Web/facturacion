...
const Businesses = ({ businesses, economic_sectors = [], business_activities = [], session, can }) => {
  ...
  return (<>
    <div className='row'>
      <div className="col-md-6">
        <div className="card">
          ...
          <div className="card-body d-flex gap-2 justify-content-center flex-wrap">
            ...
            {
              businesses.map(business => <BusinessCard { ...business } />)
            }
          </div>
        </div>
      </div>
      <div className="col-md-6">
        <div className="card">
          <h5 className="card-header">Empresas para las que trabajo</h5>
          <div className="card-body d-flex gap-2 justify-content-center flex-wrap"></div>
        </div>
      </div>
    </div>
